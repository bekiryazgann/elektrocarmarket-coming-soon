...
const ContactSection: React.FC = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row gap-6 w-full max-w-4xl mx-auto">
            ...
            >
                <div
                    className="bg-card hover:bg-accent border border-border transition-all duration-300 rounded-2xl p-8 flex flex-col items-center text-center h-full shadow-sm hover:shadow-md">
                    <div className="bg-green-500/10 p-4 rounded-full mb-4 group-hover:scale-110 transition-transform">
                        <svg fill="#25D366" width="40" height="40" viewBox="0 0 32 32" version="1.1"
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Google Haritalar üzerinden konumumuzu görün"
                className="flex-1 group"
            >
                <div
                    className="bg-card hover:bg-accent border border-border transition-all duration-300 rounded-2xl p-8 flex flex-col items-center text-center h-full shadow-sm hover:shadow-md">
                    ...
                    <h3 className="text-xl font-semibold mb-2">Yerimizde Ziyaret Edin</h3>
                    <p className="text-muted-foreground mb-4">Hızlıca yol tarifi alın.</p>
                    <span
                        className="inline-flex items-center justify-center px-6 py-2 bg-primary text-primary-foreground rounded-full text-sm font-medium">
            Haritada Görüntüle
          </span>
                </div>
            </a>
